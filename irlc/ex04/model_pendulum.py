...
def _pendulum_cost(model : DiscreteSinCosPendulumModel): # Helper method to set a discrete cost.
...
if __name__ == "__main__":
    ...
    l, m, g = model.l, model.m, 9.82
    x_dot_numpy = np.array([2, g/l * np.sin(1) + 1/(m*l**2) * 0])
