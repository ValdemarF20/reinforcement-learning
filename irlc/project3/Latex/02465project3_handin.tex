...
\toprule
                                                                           & Fabian  & Valdemar   \\
\midrule
 1: Optimal policy                                                         & 0\%  & 100\% \\
 2: Simulating a finite approximation of the optimal action-value function & 0-100\%  & 0-100\% \\
 3: Analytically computing the optimal action-value function               & 0-100\%  & 0-100\% \\
 4: Extend solution to all states and actions                              & 0-100\%  & 0-100\% \\
 5: Modified reward function                                               & 0-100\%  & 0-100\% \\
 6: Long bridge                                                            & 0-100\%  & 0-100\% \\
\bottomrule
\end{tabular}
\end{table}
