...
class Pacman9(UTestCase):
    """ Problem 9: Compute the state spaces as a list [S_0, ..., S_N] on the map 'east' using N = 7 """
    map = 'east'
    N = 7
...
class Pacman10a(UTestCase):
    """ Problem 10a: No ghost optimal path (get_shortest_path) in map 'east' using N=20 """
    map = 'east'
    N = 20
...
class Pacman10b(Pacman10a):
    """ Problem 10b: No ghost optimal path (get_shortest_path) in map 'SS0tiny' using N=20 """
    map = 'SS0tiny'

class Pacman10c(Pacman10a):
    """ Problem 10c: No ghost optimal path (get_shortest_path) in map 'datadiscs' using N=20 """
    map = 'datadiscs'

## ONE GHOST
class Pacman11a(Pacman8):
    """ Problem 11a: the p_next function with one droid """
    map = 'SS1tiny'
    action = 'East'

class Pacman11b(Pacman8):
    """ Problem 11b: the p_next function with one droid """
    map = 'SS1tiny'
    action = 'West'

class Pacman12a(Pacman9):
    """ Problem 12a:  Test the state spaces as a list [S_0, ..., S_N]. on the map 'SS1tiny' using N = 4 """
    map = 'SS1tiny'
    N = 4

class Pacman12b(Pacman9):
    """ Problem 12b: Test the state spaces as a list [S_0, ..., S_N]. on the map 'SS1tiny' using N = 6 """
    map = 'SS1tiny'
    N = 6
    pass

class Pacman13(UTestCase):
    """ Problem 13: Testing winrate on the map SS1tiny (win_probability) """
    map = 'SS1tiny'
...
class Kiosk4(UTestCase):
    """ Problem 4: solve_kiosk_1 """
...
class Project1(Report): #240 total.
    ...
    pacman_questions = [
        (Pacman7, 10), # east
        (Pacman8, 10), # p_next (g=0)
        (Pacman9, 10), # future_states (g=0)
        (Pacman10a, 4), # shortest_path (g=0)
        (Pacman10b, 3), # shortest_path (g=0)
        (Pacman10c, 3), # shortest_path (g=0)
        (Pacman11a, 5), # p_next (g=1)
        (Pacman11b, 5), # p_next (g=1)
        (Pacman12a, 5), # future_states (g=1)
        (Pacman12b, 5), # future_states (g=1)
        (Pacman13, 10),  # optimal planning (g=1)
        (Pacman14, 10), # p_next (g=2)
        (Pacman15, 10), # future_states (g=2)
        (Pacman16, 10), # optimal planning (g=2)
                 ]
